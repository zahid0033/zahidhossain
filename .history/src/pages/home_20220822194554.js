...
function Home() {
    return (
        <div className="mx-10">
            ...
            <div className="flex">
                <img className="flex-1 p-10 h-11" src="https://cdn.dribbble.com/userupload/3158902/file/original-7c71bfa677e61dea61bc2acd59158d32.jpg?resize=400x0" />
                <img className="flex-1 p-10" src="https://pbs.twimg.com/profile_images/1154314010252206080/eAG6xnof_400x400.jpg" />
                <img className="flex-1 p-10" src="https://pbs.twimg.com/profile_images/1154314010252206080/eAG6xnof_400x400.jpg" />
                <img className="flex-1 p-10" src="https://pbs.twimg.com/profile_images/1154314010252206080/eAG6xnof_400x400.jpg" />
            </div>
        </div>
