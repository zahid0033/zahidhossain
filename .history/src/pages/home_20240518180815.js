        ...
        <div className="flex-1 text-center">
          <div className="relative">
            <img
              ...
              alt=""
            />
            <div className="absolute bg-slate-50  absolute lg:top-62 md:top-56 sm:top-52 md:right-80 sm:right-px  p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white w-44 text-center">
              <h5 className="font-semibold">Web Developer</h5>
              <p className="text-sm text-slate-400 mt-1">
                3+ years of experience
              </p>
            </div>
            <div className="absolute bg-slate-50 left-2 bottom-12 p-2 absolute lg:bottom-16 md:bottom-10 bottom-2 ltr:md:-left-5 ltr:left-1 rtl:md:-right-5 rtl:right-2 rounded-lg shadow-md dark:shadow-gray-800 bg-white m-3 w-44 text-center">
