      ...
      <div className="text-gray-500 flex px-10 grid sm:grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex-1 text-center">
          <div className="relative">
            ...
            <div className="absolute bg-slate-50 left-2 bottom-12 p-2 absolute lg:bottom-16 md:bottom-10 bottom-2 ltr:md:-left-5 ltr:left-2 rtl:md:-right-5 rtl:right-2 rounded-lg shadow-md dark:shadow-gray-800 bg-white m-3 w-44 text-center">
