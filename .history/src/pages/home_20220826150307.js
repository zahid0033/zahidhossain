                ...
                <div className="text-gray-500 flex mx-10 mt-5 mb-5">
                    <div className="flex justify-center flex-1 text-white flex-col">
                        ...
                        <div className="resumeCta">
                            <a href="/cv.pdf" download class="inline-flex px-6 pt-2.5 pb-2 bg-blue-600 text-white font-medium text-xs leading-normal uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center">
