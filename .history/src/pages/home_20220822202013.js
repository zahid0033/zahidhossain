...
function Home() {
    return (
        <div className="mx-10">
            ...
            <Title text="Skills" />
            <div id="skills">
                <div className="flex grid-2 mb-6">
                    <p className="text-white flex-1">Docker</p>
                    <div className="w-full bg-gray-200 rounded-full flex-1">
                ...
                <div className="w-full bg-gray-200 rounded-full">
                    <div className=" bg-amber-200 text-xs font-medium text-black-100 text-center p-0.5 leading-none rounded-l-full w-1/2"> 50%</div>
                </div>
                <div className="w-full bg-gray-200 rounded-full">
                    <div className=" bg-amber-200 text-xs font-medium text-black-100 text-center p-0.5 leading-none rounded-l-full w-2/3"> 75%</div>
                </div>
            </div>
        </div>
    )
