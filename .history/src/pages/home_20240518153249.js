      ...
      <div className="text-gray-500 flex px-10 grid sm:grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex-1 text-center relative">
          <img
            ...
            alt=""
          />
          <div className="absolute bg-slate-50 absolute lg:top-80 md:top-56 top-48 ltr:md:-right-0 ltr:right-2 rtl:md:-left-0 rtl:left-2 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white  m-3 w-44 text-center">
