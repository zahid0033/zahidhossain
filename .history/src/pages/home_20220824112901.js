    ...
    return (
        <div className="mx-10">
            <div className="text-gray-500 flex mx-10 mt-5 mb-5">
                <div className="flex-1 text-white flex-col items-center">
            ...
            <div className="grid grid-cols-5 gap-4 items-center">
                <img className="mb-4" src="https://dreamlpg.com/assets/images/logo/logo2.png" />
                <img className="mb-4" src="https://i.ibb.co/Cw4cFTr/download.png" />
                <img className="mb-4" src="https://dreamlpg.com/assets/images/logo/logo2.png" />
                <img className="mb-4" src="https://i.ibb.co/Cw4cFTr/download.png" />
                <img className="mb-4" src="https://dreamlpg.com/assets/images/logo/logo2.png" />
            </div>
