    ...
    return (
        <div className="mx-10">
            ...
            <div id="skills" className="grid grid-cols-2 mb-10">
                ...
                <div className="flex grid-2 mb-6 mx-5 items-center">
                    <Progressbar skillName="Docker" percentage="25%" />
                </div>
                <div className="flex grid-2 mb-6 mx-5 items-center">
                    <Progressbar skillName="HTML" percentage="50%" />
                </div>
                <div className="flex grid-2 mb-6 mx-5">
                    <Progressbar skillName="Docker" percentage="75%" />
                </div>
                <div className="flex grid-2 mb-6 mx-5">
                    <Progressbar skillName="Docker" percentage="55%" />
                </div>
