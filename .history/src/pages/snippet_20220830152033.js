...
const AbTestSnippet = () => {
    ...
    return (
        <>
            ...
            <p className="mx-2 px-2 sm:mx-16 sm:px-16 text-4xl mb-10 mt-12 text-center text-sky-500 capitalize">{abTastySnippetsData[clickedSnippetNumber].fileName}</p>
            <div className="mx-2 px-2 sm:mx-16 sm:px-16 grid grid-cols-4 gap-4">
                ...
                <div className="col-span-3">
                    ...
                    <label for="themeToogle" class="inline-flex relative items-center cursor-pointer ml-8">
