        ...
        <div className="mx-10">
            ...
            <div className="text-gray-500 flex mx-10">
                <div className="flex-1 text-white">
                    ...
                    <button type="button" class="flex text-blue-500 bg-transparent border border-solid border-blue-500 hover:bg-blue-500 hover:text-white active:bg-blue-600 font-bold uppercase text-sm px-6 py-3 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 active show px-3">
