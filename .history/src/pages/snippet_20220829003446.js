...
const AbTestSnippet = () => {
    ...
    return (
        <>
            <h1 className="mx-2 px-2 sm:mx-16 sm:px-16 text-white text-4xl mb-10 mt-12 ">Snippets</h1>
            <p className="mx-2 px-2 sm:mx-16 sm:px-16 text-white text-4xl mb-10 mt-12 text-center text-sky-500">{abTastySnippetsData[clickedSnippetNumber].fileName}</p>
            <div className="mx-2 px-2 sm:mx-16 sm:px-16 grid grid-cols-4 gap-4">
                ...
                <div className="col-span-3">
                    ...
                    <label for="default-toggle" class="inline-flex relative items-center cursor-pointer">
                        <input type="checkbox" value="" id="default-toggle" class="sr-only peer" checked={showLineNumber} onClick={() => setShowLineNumbers(!showLineNumber)} />
                    ...
                    <label for="default-toggle" class="inline-flex relative items-center cursor-pointer">
                        <input type="checkbox" value="" id="default-toggle" class="sr-only peer" checked onClick={() => { theme == dracula ? setTheme("github") : setTheme(dracula) }} />
                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none  dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
