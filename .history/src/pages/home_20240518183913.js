        ...
        <div className="flex-1 text-center">
          <div className="relative">
            <img
              ...
              alt=""
            />
            <div className="absolute bg-slate-50 absolute lg:top-62 md:top-56 sm:top-52 md:right-80 sm:right-14 p-2 rounded-lg shadow-md dark:shadow-gray-800 bg-white w-44 text-center">
