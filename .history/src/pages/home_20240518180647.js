        ...
        <div className="flex-1 text-center">
          <div className="relative">
            <img
              ...
              alt=""
            />
            <div className="absolute bg-slate-50  absolute lg:top-80 md:top-56 sm:top-52 md:right-80 sm:right-px  p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white w-44 text-center">
