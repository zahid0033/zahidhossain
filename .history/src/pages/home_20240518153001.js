      ...
      <div className="text-gray-500 flex px-10 grid sm:grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex-1 text-center relative">
          <img
            ...
            alt=""
          />
          <div className="absolute bg-slate-50 right-1 top-40">
            <h5>Web Developer</h5>
            <p>3+ years of experience</p>
          </div>
          <div className="absolute bg-slate-50 left-2 bottom-12 p-2 absolute lg:bottom-20 md:bottom-10 bottom-2 ltr:md:-left-5 ltr:left-2 rtl:md:-right-5 rtl:right-2 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 m-3 w-44 text-center">
