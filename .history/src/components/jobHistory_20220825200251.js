            ...
            <div className="grid max-w-2xl mx-auto">
                <div className="flex">
                    ...
                    <div className="flex flex-col pb-6 sm:items-center sm:flex-row sm:pb-9">
                        <div>
                            <p className="text-2xl text-orange-300 font-semibold uppercase">SELCOLBD LTD</p>
                ...
                <div className="flex">
                    ...
                    <div className="flex flex-col pb-6 sm:items-center sm:flex-row sm:pb-9">
                        <div>
                            <p className="text-2xl text-orange-300 font-semibold uppercase">Dream Technology</p>
                            <p className="text-md text-lime-300 tracking-wider">Web Developer</p>
                ...
                <div className="flex">
                    ...
                    <div className="flex flex-col pb-6 sm:items-center sm:flex-row sm:pb-9">
                        <div>
                            <p className="text-2xl text-orange-300 font-semibold uppercase">Kernel Technologies</p>
                            <p className="text-md text-white"> Web Developer </p>
                            <p className="text-sm text-gray-700">
                ...
                <div className="flex">
                    ...
                    <div className="flex flex-col pb-6 sm:items-center sm:flex-row sm:pb-9">
                        <div>
                            <p className="text-2xl text-orange-300 font-semibold uppercase">Echologyx LTD</p>
                            <p className="text-md text-white"> Web Developer  </p>
                            <p className="text-sm text-gray-700">
                                The first mate and his Skipper too will do their very best to
                                make the others comfortable in their tropic island nest. Michael
