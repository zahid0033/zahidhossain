        ...
        <footer class="text-center">
            <div class="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
                <div class="max-w-3xl mx-auto space-y-6">
                    ...
                    <nav
                        class="relative flex flex-wrap justify-center gap-8 p-8 text-sm font-bold border-4 border-white text-white rounded-xl"
                    >
                        <a
                    ...
                    <p class="max-w-lg mx-auto text-xs text-gray-500">
                        ...
                        <a
                            class="block mt-1 text-pink-600 underline decoration-wavy decoration-pink-500 hover:opacity-75 text-white"
                            href="/"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
