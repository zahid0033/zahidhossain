        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-10">
            <div className="grid max-w-2xl mx-auto">
                <div className="flex">
                    ...
                    <div className="flex flex-col pb-6 sm:items-center sm:flex-row sm:pb-6">
                        <div>
                            <p className="text-4xl text-orange-300 font-semibold sm:text-base uppercase">
                                SELCOLBD LTD
                            </p>
                ...
                <div className="flex">
                    ...
                    <div className="flex flex-col pb-6 sm:items-center sm:flex-row sm:pb-6">
                        <div>
                            <p className="text-xl text-orange-300 font-semibold sm:text-base uppercase">Dream Technology</p>
                            <p className="text-sm text-gray-700">
                ...
                <div className="flex">
                    ...
                    <div className="flex flex-col pb-6 sm:items-center sm:flex-row sm:pb-6">
                        <div>
                            <p className="text-xl text-orange-300 font-semibold sm:text-base uppercase">Kernel Technologies</p>
                            <p className="text-sm text-gray-700">
                ...
                <div className="flex">
                    ...
                    <div className="flex flex-col pb-6 sm:items-center sm:flex-row sm:pb-6">
                        <div>
                            <p className="text-xl text-orange-300 font-semibold sm:text-base uppercase">Echologyx LTD</p>
                            <p className="text-sm text-gray-700">
                                The first mate and his Skipper too will do their very best to
                                make the others comfortable in their tropic island nest. Michael
                                Knight a young loner.
