...
const croTools = [
  ...
  {
    title: "Monetate",
    logo: "https://marketer.monetate.net/site_media/images/Monetate-logo-login.svg",
    styleWidth: "85%",
  },
];
...
const gallery = [
  ...
  },
  {
    ...
    alt: "",
    description:
      "It a search bar revamp. Where in control the search bar was showing regular suggestions. But in variation I showed up best selling products",
  },
  {
...
export { getAllskills, getCroTools, getOffices, getGallery };
